...
```
n_2022 and n_2021 are floating point; admission, setting, and region are char strings
...
_How many attractions had more than 1 million visitors in 2022?_
...
**NA = not available. some of the attractions did not exist in 2021 and so are na. na entries would mean that the mean and medians can't be calculated**
...
**The upper half of the visitor numbers was further away from the middle than the lower half. The visitor numbers are skewed towards the right.**
...
**For Wales and NI, the estimates are probably quite poor.**
